...
json_ld:
  ...
  softwareRequirements: See https://www.eessi.io/docs/ for how to make EESSI available
    on your system
  softwareVersion: '[''mpl-ascii/0.10.0-gfbf-2023b'']'
...
The overview below shows which mpl-ascii installations are available for RISC-V architecture in EESSI, ordered based on software version (new to old).

To start using mpl-ascii, load one of these modules using a `module load` command like:

```shell
module load mpl-ascii/0.10.0-gfbf-2023b
```
...
| |riscv64/generic|
| :---: | :---: |
|mpl-ascii/0.10.0-gfbf-2023b|x|


### mpl-ascii/0.10.0-gfbf-2023b
