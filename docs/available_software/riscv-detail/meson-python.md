...
json_ld:
  ...
  softwareRequirements: See https://www.eessi.io/docs/ for how to make EESSI available
    on your system
  softwareVersion: '[''meson-python/0.15.0-GCCcore-13.2.0'']'
...
The overview below shows which meson-python installations are available for RISC-V architecture in EESSI, ordered based on software version (new to old).
...
| |riscv64/generic|
| :---: | :---: |
|meson-python/0.15.0-GCCcore-13.2.0|x|
