...
json_ld:
  ...
  softwareRequirements: See https://www.eessi.io/docs/ for how to make EESSI available
    on your system
  softwareVersion: '[''SciPy-bundle/2023.11-gfbf-2023b'']'
...
The overview below shows which SciPy-bundle installations are available for RISC-V architecture in EESSI, ordered based on software version (new to old).
...
| |riscv64/generic|
| :---: | :---: |
|SciPy-bundle/2023.11-gfbf-2023b|x|
