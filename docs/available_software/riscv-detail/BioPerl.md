...
json_ld:
  ...
  softwareRequirements: See https://www.eessi.io/docs/ for how to make EESSI available
    on your system
  softwareVersion: '[''BioPerl/1.7.8-GCCcore-13.2.0'']'
...
The overview below shows which BioPerl installations are available for RISC-V architecture in EESSI, ordered based on software version (new to old).
...
| |riscv64/generic|
| :---: | :---: |
|BioPerl/1.7.8-GCCcore-13.2.0|x|
