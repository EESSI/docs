...
json_ld:
  ...
  softwareRequirements: See https://www.eessi.io/docs/ for how to make EESSI available
    on your system
  softwareVersion: '[''Perl/5.36.1-gfbf-2023b'', ''Perl/5.38.0'', ''Perl/5.38.0-GCCcore-13.2.0'']'
...
The overview below shows which Perl installations are available for RISC-V architecture in EESSI, ordered based on software version (new to old).
...
| |riscv64/generic|
| :---: | :---: |
|Perl/5.38.0-GCCcore-13.2.0|x|
|Perl/5.38.0|x|
|Perl/5.36.1-gfbf-2023b|x|
