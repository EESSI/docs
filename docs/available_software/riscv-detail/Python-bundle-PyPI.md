...
json_ld:
  ...
  softwareRequirements: See https://www.eessi.io/docs/ for how to make EESSI available
    on your system
  softwareVersion: '[''Python-bundle-PyPI/2023.10-GCCcore-13.2.0'']'
...
The overview below shows which Python-bundle-PyPI installations are available for RISC-V architecture in EESSI, ordered based on software version (new to old).
...
| |riscv64/generic|
| :---: | :---: |
|Python-bundle-PyPI/2023.10-GCCcore-13.2.0|x|
