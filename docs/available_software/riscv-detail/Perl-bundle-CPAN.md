...
json_ld:
  ...
  softwareRequirements: See https://www.eessi.io/docs/ for how to make EESSI available
    on your system
  softwareVersion: '[''Perl-bundle-CPAN/5.38.0-GCCcore-13.2.0'']'
...
The overview below shows which Perl-bundle-CPAN installations are available for RISC-V architecture in EESSI, ordered based on software version (new to old).
...
| |riscv64/generic|
| :---: | :---: |
|Perl-bundle-CPAN/5.38.0-GCCcore-13.2.0|x|
