...
json_ld:
  ...
  softwareRequirements: See https://www.eessi.io/docs/ for how to make EESSI available
    on your system
  softwareVersion: '[''LightGBM/4.5.0-foss-2023b'']'
...
The overview below shows which LightGBM installations are available for RISC-V architecture in EESSI, ordered based on software version (new to old).

To start using LightGBM, load one of these modules using a `module load` command like:

```shell
module load LightGBM/4.5.0-foss-2023b
```
...
| |riscv64/generic|
| :---: | :---: |
|LightGBM/4.5.0-foss-2023b|x|


### LightGBM/4.5.0-foss-2023b
