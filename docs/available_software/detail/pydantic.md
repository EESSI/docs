...
json_ld:
  ...
  softwareRequirements: See https://www.eessi.io/docs/ for how to make EESSI available
    on your system
  softwareVersion: '[''2.11.9'', ''2.11.7'', ''2.9.1'', ''2.7.4'', ''2.5.3'']'
...
|2.11.7|`generic`: `aarch64`, `x86_64`<br/><span class="software-cpu-arm">Arm</span>: `a64fx`, `neoverse_n1`, `neoverse_v1`, `nvidia/grace`<br/><span class="software-cpu-amd">AMD</span>: `zen2`, `zen3`, `zen4`, `zen5`<br/><span class="software-cpu-intel">Intel</span>: `haswell`, `skylake_avx512`, `sapphirerapids`, `icelake`, `cascadelake`<br/>|*(none)*|<span class="software-eessi-version-202506">2025.06</span>|`pydantic/2.11.7-GCCcore-14.2.0`|
...
| --- | --- |
|0.7.0|`pydantic/2.11.9-GCCcore-14.3.0`<br/>`pydantic/2.11.7-GCCcore-14.2.0`<br/>`pydantic/2.9.1-GCCcore-13.3.0`|
...
|2.11.7|`pydantic/2.11.7-GCCcore-14.2.0`|
...
| --- | --- |
|2.33.2|`pydantic/2.11.9-GCCcore-14.3.0`<br/>`pydantic/2.11.7-GCCcore-14.2.0`|
...
| --- | --- |
|0.4.1|`pydantic/2.11.9-GCCcore-14.3.0`<br/>`pydantic/2.11.7-GCCcore-14.2.0`|