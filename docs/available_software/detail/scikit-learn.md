...
json_ld:
  ...
  description: 'Scikit-learn integrates machine learning algorithms in the tightly-knit
    ...
    it provides versatile tools for data mining and analysis in any field of science
    and engineering.

    It strives to be simple and efficient, accessible to everybody, and reusable in
    various contexts.'
...
| --- | --- |
|0.0|`scikit-learn/1.7.1-gfbf-2025b`<br/>`scikit-learn/1.7.0-gfbf-2025a`<br/>`scikit-learn/1.5.2-gfbf-2024a`<br/>`scikit-learn/1.4.0-gfbf-2023b`<br/>`scikit-learn/1.3.1-gfbf-2023a`|