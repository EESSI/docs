...
json_ld:
  ...
  softwareRequirements: See https://www.eessi.io/docs/ for how to make EESSI available
    on your system
  softwareVersion: '[''1.4.4'', ''1.3.0'', ''1.2.2.post1'', ''1.0.3'']'
...
| --- | --- |
|1.4.4|`build/1.4.4-GCCcore-15.2.0`|
...
| --- | --- |
|1.2.0|`build/1.4.4-GCCcore-15.2.0`<br/>`build/1.3.0-GCCcore-14.3.0`<br/>`build/1.3.0-GCCcore-14.2.0`|
