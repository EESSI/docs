...
| --- | --- |
|0.8.0|`scikit-build-core/0.5.0-GCCcore-12.3.0`<br/>`scikit-build-core/0.9.3-GCCcore-12.3.0`<br/>`scikit-build-core/0.9.3-GCCcore-13.2.0`<br/>`scikit-build-core/0.10.7-GCCcore-13.2.0`|
