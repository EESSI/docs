...
json_ld:
  ...
  description: "MAFFT is a multiple sequence alignment program for unix-like operating\
    \ systems.\nIt offers a range of multiple alignment methods, L-INS-i (accurate;\
    \ for alignment\nof <\u223C200 sequences), FFT-NS-2 (fast; for alignment of <\u223C\
...
Overview of extensions included in MAFFT installations
