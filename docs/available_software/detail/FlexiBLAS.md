...
json_ld:
  ...
  softwareRequirements: See https://www.eessi.io/docs/ for how to make EESSI available
    on your system
  softwareVersion: '[''3.5.0'', ''3.4.5'', ''3.4.4'', ''3.3.1'', ''3.2.1'']'
...
| --- | --- |
|3.5.0|`FlexiBLAS/3.5.0-GCC-15.2.0`<br/>`FlexiBLAS/3.5.0-llvm-compilers-21.1.8`|
...
| --- | --- |
|3.12.1|`FlexiBLAS/3.5.0-GCC-15.2.0`<br/>`FlexiBLAS/3.5.0-llvm-compilers-21.1.8`<br/>`FlexiBLAS/3.4.5-GCC-14.3.0`<br/>`FlexiBLAS/3.4.5-llvm-compilers-20.1.8`|
