...
json_ld:
  ...
  softwareRequirements: See https://www.eessi.io/docs/ for how to make EESSI available
    on your system
  softwareVersion: '[''4.4.1'', ''4.3.1'', ''4.3.0'']'
...
<small>homepage: </small><span class="software-link">[http://heasarc.gsfc.nasa.gov/fitsio/](http://heasarc.gsfc.nasa.gov/fitsio/)</span>
