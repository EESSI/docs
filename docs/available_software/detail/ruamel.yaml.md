...
json_ld:
  ...
  softwareRequirements: See https://www.eessi.io/docs/ for how to make EESSI available
    on your system
  softwareVersion: '[''0.18.6'', ''0.18.14'', ''0.17.32'']'
...
| --- | --- |
|0.3.2|`ruamel.yaml/0.17.32-GCCcore-12.3.0`<br/>`ruamel.yaml/0.18.14-GCCcore-14.3.0`<br/>`ruamel.yaml/0.18.6-GCCcore-13.2.0`|
...
| --- | --- |
|0.6.5|`ruamel.yaml/0.17.32-GCCcore-12.3.0`<br/>`ruamel.yaml/0.18.14-GCCcore-14.3.0`<br/>`ruamel.yaml/0.18.6-GCCcore-13.2.0`|
